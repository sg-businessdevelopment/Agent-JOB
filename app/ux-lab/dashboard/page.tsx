  ...
  return (
    <div className="container mx-auto px-4 py-8">
      <div className="text-center mb-12">
        ...
        <p className="text-lg text-muted-foreground max-w-2xl mx-auto">Agentのワークスペースへようこそ</p>
      </div>
      ...
      <div className="max-w-4xl mx-auto">
        ...
        <div>
          <div className="mt-12 p-6 bg-muted rounded-lg">
            ...
            <p className="text-muted-foreground">テキスト テキスト テキスト テキスト</p>
          </div>

          <div className="mt-4 p-6 bg-muted rounded-lg">
            <h3 className="text-lg font-semibold mb-3">
              UXデザイナーが既存デザインシステムを使って新規UI画面を作る場合
            </h3>
            ...
            <div className="flex items-center p-6 pt-4 rounded-m border bg-card shadow-normal-s">
              <div className="text-base text-gray-600 font-medium">
                ...
                <h3 className="text-sm text-gray-500 pt-4">
                  <span className="block">• app/*/ ディレクトリ（＝各ページやフローに対応）</span>
                  <span className="block pt-2">• ページ単位の page.tsx、必要に応じて page.module.css </span>
                  <span className="block pt-2">
                    • などomponents/ 配下で個別のページ用に分けられた補助コンポーネント（例：MyPageSection.tsxなど）
                  </span>
                </h3>
              </div>
            </div>
